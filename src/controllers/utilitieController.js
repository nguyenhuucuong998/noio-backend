...
import { utilitieService } from "~/services/utilitieService";

const getAll = async (req, res, next) => {
  try {
    const getAll = await utilitieService.getAll(); // có kết quả thì trả về cho client, không có kết quả thì trả về lỗi
...
export const utilitieController = {
  getAll,
};
